---
title: "4.7 — Preference Falsification"
...
## [Sparks & Prairie Fires: Unanticipated Revolutions](#46)
...
.left-column[
.center[
![:scale 80%](../images/timurkuran.png)
.smallest[
Timur Kuran
...
.pull-left[
.center[
![](../images/preference_falsification.jpg)
]
]
...
.center[
![:scale 75%](../images/Maimon-Marrans.jpg)
...
.pull-left[
.center[
![](../images/preference_influence.jpg)
]
]
...
.center[
![:scale 70%](../images/preference_false_fig1.png)
]
...
.center[
![:scale 80%](../images/preference_false_fig2.png)
]
...
.center[
![:scale 80%](../images/preference_false_fig3.png)
]
...
.pull-left[
.center[
![:scale 75%](../images/tombradley.jpg)
.smaller[
...
.center[
![:scale 80%](../images/brexit_polling.jpg)
]
...
.center[
![:scale 100%](../images/brexitvote1.png)
]
...
.center[
![:scale 70%](../images/2016_nytimes_election_prediction.png)
]
...
.center[
![:scale 50%](../images/confirmation_bias_fake_news.jpeg)
]
...
.pull-left[
.center[
![:scale 100%](../images/assadposter.jpeg)
]
]

.pull-right[
.center[
![:scale 100%](../images/northkoreaelection.jpg)
]
]
...
.pull-left[
.center[
![:scale 80%](../images/bouazizi1.png)
]
]

.pull-left[
.center[
![:scale 100%](../images/bouazizi2.png)
]
]
...
.center[
![:scale 90%](../images/arabspring.png)
]
...
.center[
![](../images/arab_spring_outcome.jpg)
]
...
.pull-left[
.smallest[
- .hi[Virtue signaling]: publicly expressing opinions or sentiments intended to demonstrate one's good character/moral correctness
  - Specifically to one's .hi-purple[*in*-group]
  - Often by denigrating the .hi-purple[*out*-group]

> “Me against my brother, my brothers and me against my cousins, then my cousins and me against strangers.” - Bedouin proverb*

- One of the greatest reads on this: [*Slate Star Codex*: I Can Tolerate Anything but the Outgroup](https://slatestarcodex.com/2014/09/30/i-can-tolerate-anything-except-the-outgroup/) 
]
]

.pull-right[
.center[
![](../images/reusablebag.jpg)
]
]
...
- .hi-purple[How much of your (and others') actions and words are (virtue) signaling and how much is what you (they) actually think and want?]

]

.pull-right[
.center[
![](../images/hansonsignal.jpg)
]
]
---
...
- “Virtue-signaling” is a poor name! Consider game with asymmetric information, a .hi[signal] is meant to **differentiate** types of players from each other
