...
- .hi-purple[Decision nodes]: decision point for each player
  - Solid nodes, I've labeled and color-coded by player
...
2. (.red[Send], .blue[Keep]): .red[0], .blue[200] 
3. (.red[Send], .blue[Share]): .red[150], blue[50]
...
- .hi-red[Principal] has 2 strategies:
  1. .red[Don't] at .red[P.1]
  2. .red[Invest] at .red[P.1]

- .hi-blue[Agent] has 2 strategies:
...
.center[
![:scale 75%](../images/3_player_game.png)
]
...
.center[
![:scale 75%](../images/3_player_game_2.png)
]
...
.center[
![:scale 75%](../images/3_player_game_3.png)
]
...
.center[
![:scale 75%](../images/3_player_game_rollback.png)
]
