...
We can then construct <span style=color:red;>Your Best Response</span>$=\begin{cases} Italian & \text{if }p<\frac{2}{3}\\ Indifferent & \text{if }p=\frac{2}{3}\\ Chinese & \text{if }p>\frac{2}{3}\\ \end{cases}$
...
ggplot(data = tibble(x = c(0,1)))+
  aes(x = x)+
  geom_segment(x = 0, xend = 0.667, y = 0, yend = 0, color = "blue", size = 1)+
  geom_segment(x = 0.667, xend = 0.667, y = 0, yend = 1, color = "blue", size = 1)+
