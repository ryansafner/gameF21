...
ui <- fluidPage(
    ...
    # Application title
    titlePanel("ECON 316 Course Grade Calculator"),
    ...
    sidebarLayout(
        ...
        mainPanel(
           ...
           p("Made with",
             ...
             "'s", 
             a("Game Theory",
               href="http://gamef21.classes.ryansafner.com"),
...
server <- function(input, output) {
    ...
    output$printgrades <- renderText({
        coursegrade<-round(((input$exam1*0.25)+(input$final*0.25)+(input$hw*0.25)+(input$paper*0.25)),4)
