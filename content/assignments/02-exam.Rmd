...
{{% alert note %}}
Due by email 8:00 PM Friday, December 10. 
{{% /alert %}}
...
Watch the famous Mexican standoff scene near the end of Sergio Leone's 1966 masterpiece *The Good, the Bad, and the Ugly* ([Link](https://www.youtube.com/watch?v=aJCSNIl2Pls))

<iframe width="980" height="550" src="https://www.youtube.com/embed/aJCSNIl2Pls" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
